...
public class MecanumDriver extends CommandBase {
    ...
    public void initialize() {
        // Nothing here, we wait for input instead of immediately doing something.
    }
    ...
    public void execute() {
        m_drivebase.drive(
            ...
            RobotContainer.getInstance().getjL().getY(),
            // Left joystick, x-axis (left/right) 
            RobotContainer.getInstance().getjL().getX(),
            // Right joystick, x-axis (left/right) 
            RobotContainer.getInstance().getjR().getX()
        );
    }
